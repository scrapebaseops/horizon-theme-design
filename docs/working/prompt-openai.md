# Prompt: OpenAI variant (parallel run)

Use this in OpenAI for the OpenAI experiment only.
...
2. Edit files only under `horizon-themes/openai`.
3. Do not edit root docs/config, `.cursor`, `lexington-reference`, or other variants.
4. Write all run artifacts under `horizon-themes/openai/.rebuild`.
5. Maintain `horizon-themes/openai/.rebuild/run-manifest.json`.
6. No commits during loops; checkpoints live in `.rebuild`.

Before edits, print:
`ACTIVE_SCOPE=horizon-themes/openai`
...
- `horizon-themes/openai/.rebuild/theme-mapping.md`
- `horizon-themes/openai/.rebuild/rebuild-plan.md`
- `horizon-themes/openai/.rebuild/benchmark-spec.md`
- `horizon-themes/openai/.rebuild/visual-parity-log.md`
- `horizon-themes/openai/.rebuild/STATUS.md`

Screenshot SOP:

- Viewports: `1440x900`, `768x1024`, `390x844`
- Save under `horizon-themes/openai/.rebuild/screenshots/loop-XX/`
